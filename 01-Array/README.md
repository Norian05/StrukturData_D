...
Melalui beberapa latihan praktikum yang diberikan, saya bisa melihat bagaimana konsep list dan array diterapkan dalam program, seperti menyimpan data nilai, mencari nilai maksimum dan minimum, serta menghitung rata-rata. Dari proses pembelajaran ini, saya menyadari bahwa pemilihan struktur data yang tepat sangat mempengaruhi kinerja program, sehingga penting bagi saya untuk memahami konsep dasarnya dengan baik sebagai bekal untuk mempelajari materi struktur data dan pemrograman lainnya
